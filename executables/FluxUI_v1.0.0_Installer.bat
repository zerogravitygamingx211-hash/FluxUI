...
echo Copying files...
copy "executables\FluxUI.exe" "C:\Program Files\FluxUI\bin\" > nul
copy "executables\fluxui-cli.exe" "C:\Program Files\FluxUI\bin\" > nul
copy "Scripts\fluxui.py" "C:\Program Files\FluxUI\lib\" > nul
copy "Scripts\parser.py" "C:\Program Files\FluxUI\lib\" > nul
copy "Scripts\tokenizer.py" "C:\Program Files\FluxUI\lib\" > nul
copy "Scripts\engine.py" "C:\Program Files\FluxUI\lib\" > nul
copy "Scripts\components.py" "C:\Program Files\FluxUI\lib\" > nul
copy "Scripts\ui_engine.py" "C:\Program Files\FluxUI\lib\" > nul
copy "Scripts\fluxui_cli.py" "C:\Program Files\FluxUI\lib\" > nul
copy "Scripts\fluxui_ide.py" "C:\Program Files\FluxUI\lib\" > nul
...
powershell -Command "$WshShell = New-Object -comObject WScript.Shell; $Shortcut = $WshShell.CreateShortcut('%PUBLIC%\Desktop\FluxUI.lnk'); $Shortcut.TargetPath = 'C:\Program Files\FluxUI\bin\fluxui.exe'; $Shortcut.Description = 'FluxUI Programming Language v1.0.0'; $Shortcut.Save()"
